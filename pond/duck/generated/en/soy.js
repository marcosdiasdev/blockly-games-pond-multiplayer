...
Pond.Duck.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return Pond.soy.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Pond_rabbitName">Rabbit</span><span id="Pond_counterName">Counter</span><span id="Pond_rookName">Player 2</span><span id="Pond_sniperName">Sniper</span><span id="Pond_myName">Player 1</span></div>';
};
if (goog.DEBUG) {
